...
"""autogenerated by genpy from uuv_control_msgs/WaypointSet.msg. Do not edit."""
import codecs
import sys
...
class WaypointSet(genpy.Message):
  _md5sum = "a946aaa8d17e35fe5a52e4f7ac482b5d"
  _type = "uuv_control_msgs/WaypointSet"
...
float64 z
"""
  __slots__ = ['header','start_time','waypoints']
  _slot_types = ['std_msgs/Header','std_msgs/Time','uuv_control_msgs/Waypoint[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(WaypointSet, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2I().pack(_x.start_time.data.secs, _x.start_time.data.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.start_time.data.secs, _x.start_time.data.nsecs,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.waypoints = []
